from src.file_utils import read_file_to_list
from src.k_means_utils import get_k_means_cluster, get_tfidf_terms
...
if __name__ == "__main__":
    titles_path = cluster_dir + "titles"
    terms_path = cluster_dir + "/terms"
    X_Y_list = load_label_and_terms(titles_path, terms_path)
